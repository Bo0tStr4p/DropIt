<html>
    ...
    <body>
        ...
        <?php
            ...
            $dbconn = pg_connect("host=localhost port=5434 dbname=DropIT_DB user=postgres password=password") or die('Could not connect: ' . pg_last_error());
            if(!(isset($_POST['registrationButton']))){
                ...
                if($line=pg_fetch_array($result,null,PGSQL_ASSOC)){
                    ...
                    $q2="insert into user values ($1,$2,$3,$4,$5)";
