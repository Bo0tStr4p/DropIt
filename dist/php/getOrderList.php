<?php
    ...
    $q2 = "select o.id,o.description,o.orderdate,o.address,o.status from myorder o join makes m on m.id = o.id join myuser u on u.email = m.email where u.email=$1 and u.password=$2";
